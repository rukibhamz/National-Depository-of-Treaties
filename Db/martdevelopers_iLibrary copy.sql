...
--
-- Host: localhost
-- Generation Time: Feb 09, 2023 at 05:05 AM
...
(4, 'BC-CAVGI', 'Recent treaties', 'Nonfiction or non-fiction is content that purports in good faith to represent truth and accuracy regarding information, events, or people. Nonfiction content may be presented either objectively or subjectively, and may sometimes take the form of a story. This is an updated book category description'),
(5, 'BC-JVQBM', 'Recent notifications', 'A fiction is a deliberately fabricated account of something. It can also be a literary work based on imagination rather than on fact, like a novel or short story. The Latin word fictus means â€œto form,â€ which seems like a good source for the English word fiction, since fiction is formed in the imagination.'),
(6, 'BC-AHGWJ', 'Top treaties', 'Reference materials are various sources that provide background information or quick facts on any given topic.');
...
INSERT INTO `iL_Books` (`b_id`, `b_title`, `b_author`, `b_isbn_no`, `b_publisher`, `b_coverimage`, `b_file`, `bc_id`, `bc_name`, `b_status`, `created_at`, `b_summary`, `b_copies`) VALUES
...
(6, 'lib001@ilib.org', 'Librarian', 'DTZJK8V024', 'cdc03f9e99e5fd9faa0de8ef30f986b2e2345086', 'Pending', '2023-01-09 19:28:49'),
(7, 'cobham.victor@gmail.com', 'Student', 'HOCBVI19DL', '2db573bb8358241ec0a0341a6c0633903487ef3e', 'Pending', '2023-01-11 12:16:39');
...
(3, 'Student 001', 'iLib-37508', 'cobham.victor@gmail.com', '3650f030191228216dc0e4bbac7de0b2f5f39c8e', 'Select Gender', '+906756432', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc,', '127001 Localhost', '', 'Active', '2023-01-11 12:15:36.911591'),
...
(1, 'Architectural Digest', 'SUB-90625', 'Art & Architecture', 'Architectural Digest is the world\'s foremost design authority, showcasing the work of top architects and interior decorators. It continues to set new benchmarks for how to live wellâ€”what to buy, what to see and do, where to travel, and who to watch on the fast-paced, multifaceted global design scene.', 'Architectural Digest .jpg', '2023-02-06 15:04:08.308191', 'DAVID_BENARD_CV.pdf', 'Conde Nast US', 'April 2020');
...
--
ALTER TABLE `iL_BookCategories`
  MODIFY `bc_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `iL_Books`
--
ALTER TABLE `iL_Books`
  MODIFY `b_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `iL_PasswordResets`
  MODIFY `pr_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
