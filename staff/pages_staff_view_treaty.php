                            ...
                            <div class="user_heading user_heading_bg" style="background-image: url('../sudo/assets/img/books/<?php echo $row->b_coverimage;?>')">
                                <div class="bg_overlay">
                                    ...
                                    <div class="user_heading_content">
                                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $row->title;?></span><span class="sub-heading">ISBN NO: <?php echo $row->b_isbn_no?></span></h2>
                                            ...
                                            <div class="uk-width-large-1-2">
                                                ...
                                                <ul class="md-list md-list-addon">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="md-list-content">
                                                            <span class="md-list-heading"><?php echo $row->b_status;?></span>
