    ...
    <div id="page_content">
        ...
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>Running Treaties</span></li>
            </ul>
        </div>
        <div id="page_content_inner">
            <?php
            $ret = "SELECT * FROM tbl_treaties WHERE s_status='Running'";
            $stmt = $mysqli->prepare($ret);
            $stmt->execute();
            $res = $stmt->get_result();
            $numRows = $res->num_rows;
            ?>
            <h3 class="heading_a uk-margin-bottom text">Number of Running Treaties ( <?= $numRows ?> )</h3>
