        ...
        while($row=$res->fetch_object())
        {
            ...
            if($row->profile_pic == '')
            {
                $profile_picture = "
                    ...
                    <img src='assets/profile_img/user_icon.png' alt='User Image'>
                    ";
            }
            else
            {
                $profile_picture = 
                "
                    <img src='assets/profile_img/$row->profile_pic' alt='user avatar'/>
                ";
            }
                            ...
                            <div class="user_heading user_heading_bg" style="background-image: url('assets/img/Menu_bg.png')">
                                ...
                                <div class="bg_overlay">
                                    ...
                                    <div class="user_heading_content">
                                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?= $row->username;?></span><span class="sub-heading"><?= $row->email; ?></span></h2>
                                        <!--
                                        <ul class="user_stats">
                                            <li>
                    ...
                    <div class="uk-width-large-3-10 hidden-print">
                        <div class="md-card">
                            <div class="md-card-content">
                                ...
                                <h3 class="heading_c uk-margin-bottom"> Users(Admins) Accounts</h3>
                                            ...
                                            while($row=$res->fetch_object())
                                            {
                                                ...
                                                if($row->profile_pic == '')
                                                {
                                                    $profile_picture = "
                                                        ...
                                                        <img class='md-user-image md-list-addon-avatar' src='assets/profile_img/user_icon.png' alt='User Image'>
                                                        ";
                                                }
                                                else
                                                {
                                                    $profile_picture = 
                                                    "
                                                        <img  class='md-user-image md-list-addon-avatar' src='assets/profile_img/$row->profile_pic' alt='user avatar'/>
                                                    ";
                                                }
