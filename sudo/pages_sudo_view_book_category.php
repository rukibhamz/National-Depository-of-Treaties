        ...
        <div id="page_content">
            ...
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><span><?php echo $row->treaty_name;?></span></li>
                </ul>
            </div>
                            ...
                            <div class="user_heading user_heading_bg" style="background-image: url('assets/img/gallery/Image10.jpg')">
                                <div class="bg_overlay">
                                    ...
                                    <div class="user_heading_content">
                                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $row->treaty_name;?></span><span class="sub-heading"><?php echo $row->treaty_code;?></span></h2>
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <ul id="user_profile_tabs" class="uk-tab" data-uk-tab="{connect:'#user_profile_tabs_content', animation:'slide-horizontal'}" data-uk-sticky="{ top: 48, media: 960 }">
                                    <li class="uk-active"><a href="#"><?php echo $row->treaty_name;?> Details</a></li>
                                    <!--
