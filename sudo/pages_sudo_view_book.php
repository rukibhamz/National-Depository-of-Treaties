...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    while ($row = $res->fetch_object()) {
        ...
        if ($row->b_coverimage == '') {
            $cover_image = "<img src='assets/img/books/default.png' alt='Book Image'>";
        } else {
                ...
                <div class="uk-width-large-10-10">
                    <div class="md-card">
                        <div class="user_heading user_heading_bg"
                            style="background-image: url('assets/img/books/default.png')">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon uk-text-success material-icons">person</i>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon  uk-text-success material-icons">theaters</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span
                                                            class="md-list-heading"><?php echo $row->b_publisher; ?></span>
                                        ...
                                        <div class="uk-width-large-1-2">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon uk-text-success material-icons">spellcheck</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span
                                                            class="md-list-heading"><?php echo $row->b_copies; ?></span>
                                                        <span class="uk-text-small uk-text-muted">Number Of Copies
                                                            Available</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon uk-text-success material-icons">description</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span
